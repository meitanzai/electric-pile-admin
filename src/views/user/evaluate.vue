    ...
    <div>
                ...
                <div class="text-item">
                    <el-form :inline="true" :model="EvaluateListQuery">
                        ...
                        <el-form-item label="类型">
                            <el-select v-model="EvaluateListQuery.genre" placeholder="状态">
                                <el-option label="电站评价" value="1"></el-option>
                                <el-option label="电桩评价" value="2"></el-option>
                            </el-select>
                        </el-form-item>
            ...
            <el-main>
                ...
                <div>
                    <el-table :data="tableData" v-loading="listLoading" @selection-change="handleSelectionChange" border
                        ...
                        <el-table-column label="用户编号" width="60" align="center">
                            <template slot-scope="scope">{{scope.row.userId}}</template>
                        </el-table-column>
                        <el-table-column label="电站编号" width="60" align="center">
                            <template slot-scope="scope">{{scope.row.stationId}}</template>
                        </el-table-column>
                        <el-table-column label="电桩编号" width="60" align="center">
                            <template slot-scope="scope">{{scope.row.pileId}}</template>
                        </el-table-column>
                        <el-table-column label="订单编号" width="60" align="center">
                            <template slot-scope="scope">{{scope.row.orderId}}</template>
                        </el-table-column>
                        <el-table-column label="类型" width="100" align="center">
                            <template slot-scope="scope">
                                <el-tag type="primary" effect="plain" v-if="scope.row.genre===1">电站评价</el-tag>
                                <el-tag type="success" effect="plain" v-if="scope.row.genre===2">电桩评价</el-tag>
                            </template>
                        </el-table-column>
        ...
        <el-dialog title="评价记录信息" :visible.sync="dialogFormVisible" width="25%">
            <el-form label-width="80px" size="small">
                ...
                <el-form-item label="类型">
                    <el-select v-model="form.genre" placeholder="状态">
                        <el-option label="电站评价" value="1"></el-option>
                        <el-option label="电桩评价" value="2"></el-option>
                    </el-select>
                </el-form-item>
